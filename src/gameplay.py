...
class GameScene:
    def __init__(self, world_name: str, creatures : list[Creature] = [], foods : defaultdict[str, int] | None = None, potions : defaultdict[str, int] | None = None, cleanse : defaultdict[str, int] | None = None):
        ...
        self.market_items : list[dict[str, str | int | pygame.Surface]] = [
            ...
            {"name": "Spam", "price": 15, "icon": self.icon_spam, "for-type" : "Quaker", "Satisfaction" : 25},

            {"name": "Cassis", "price": 10, "icon": self.icon_cassis, "for-type" : "mimi-carrier", "Satisfaction" : 12},
            {"name": "Cherry", "price": 10, "icon": self.icon_cherry, "for-type" : "mimi-carrier", "Satisfaction" : 12},
            {"name": "Aisu", "price": 10, "icon": self.icon_aisu, "for-type" : "mimi-carrier", "Satisfaction" : 12},
    ...
    def use_item(self, item_name: str):
        self.inventory.remove_inventory(item_name)
